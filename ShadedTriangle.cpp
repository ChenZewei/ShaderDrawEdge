...
void SetupRC()
	...
	Edge = gltLoadShaderPairWithAttributes("ShadedIdentityEdge.vp", "ShadedIdentityEdge.fp", 1, 
...
void RenderScene(void)
	...
	glUseProgram(Edge);
	GLint location = glGetUniformLocation(Edge,"center");
	glUniform4f(location,0.0,0.25,0.0,1.0);
